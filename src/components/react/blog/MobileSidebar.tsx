...
export const MobileSidebar: React.FC<Props> = ({ headings, relatedPosts }) => {
  ...
  const handleLinkClick = (slug: string) => {
    setOpen(false);
    // Small delay so the sheet closes before scroll starts
    setTimeout(() => {
        ...
        {open && (
          <>
            ...
            <motion.div
              ...
              className="xl:hidden fixed bottom-0 left-0 right-0 z-50 max-h-[70vh] overflow-y-auto rounded-t-2xl border-t border-line bg-surface"
            >
              {/* Drag handle */}

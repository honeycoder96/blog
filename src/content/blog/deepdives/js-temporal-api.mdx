...
The cookbook at <a href="https://tc39.es/proposal-temporal/docs/cookbook.html" target="_blank" rel="noopener noreferrer">tc39.es/proposal-temporal/docs/cookbook.html</a> is excellent for going deeper — it has worked examples for dozens of real-world patterns from "convert between timezones" to "next occurrence of a weekday."

...
relatedPosts: []
prevPost: js/promises-in-depth
nextPost: custom-react-renderer
---
...
```js
// SANDPACK DEMO 1 — Call Stack Trace
// Tip: open the browser console and step through with debugger
...
```js
// SANDPACK DEMO 2 — Blocking the Thread

...
DevForum's API call: `fetch('https://api.devforum.com/v1/posts', { method: 'POST', headers: { 'Content-Type': 'application/json' }, credentials: 'include' })` triggers a preflight because of the `application/json` content type.

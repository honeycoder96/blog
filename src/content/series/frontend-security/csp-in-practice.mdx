...
DOMPurify 3.0.8 had a mutation XSS edge case involving SVG foreign object elements. It was disclosed, patched, and fixed in 3.0.9. But DevForum was running 3.0.7, pinned, with no automated updates. A researcher found the edge case and submitted a payload through the comment form.
...
`blocked-uri: "inline"` means an inline script without a matching nonce would have been blocked. `violated-directive: "script-src-elem"` tells you which directive fired. `document-uri` tells you which page.

...
<ArchFlow
  title="Dependency Confusion — Two Packages, One Name Wins"
  direction="horizontal"
  nodes={[
    { label: "@devforum/utils@1.4.0", sublabel: "Private GitHub Packages registry — legitimate" },
    { label: "npm Resolver", sublabel: ".npmrc: registry + @devforum:registry" },
    { label: "devforum-utils@9.9.9", sublabel: "Public npm registry — attacker-controlled" },
  ]}
/>

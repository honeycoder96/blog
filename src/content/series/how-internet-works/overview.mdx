...
|---|------|-------------------|
| 1 | [What Happens When You Press Enter? URL Parsing, Caches & the HSTS List](/series/how-internet-works/press-enter) | URL anatomy, the browser's pre-network decision tree, HSTS preload, DNS and HTTP cache lookup, Service Worker intercept |
...
| # | Post | What you'll learn |
|---|------|-------------------|
| 2 | [DNS Resolution: How google.com Becomes an IP Address](/series/how-internet-works/dns-resolution) | Recursive resolution journey, root/TLD/authoritative nameservers, resolver caches, TTL, reading a DNS response |
| 3 | [DNS Records, `dig`, Glue Records & Modern DNS](/series/how-internet-works/dns-records-dig) | A, AAAA, CNAME, MX, TXT, NS, SOA records; `dig` command walkthrough; glue records; DNS over HTTPS and TLS |
